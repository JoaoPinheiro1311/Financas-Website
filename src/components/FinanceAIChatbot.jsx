...
export default function FinanceAIChatbot() {
  ...
  return (
    <div className="fixed bottom-6 right-6 w-[450px] bg-white rounded-2xl shadow-2xl flex flex-col z-50 max-h-[600px]">
      {/* Header */}
      ...
      {!minimized && (
        <>
          {/* Messages */}
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50 max-h-[480px]">
